...
//  Homework #7
//
//  Created by Marlayna Verenna on 4/6/20.
...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    // Disney Coordinates
    let disneyLatitude: CLLocationDegrees = 28.3852
    let disneyLongitude: CLLocationDegrees = -81.5639
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if newLocation.horizontalAccuracy >= 0 {
            ...
            let disney:CLLocation = CLLocation(latitude: disneyLatitude, longitude: disneyLongitude)
